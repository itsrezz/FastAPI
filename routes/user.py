...
from fastapi import Response, Cookie, responses, Request
...
# from utils import encode_access_token, decode_access_token, authenticate_user, get_current_user, get_session_id
...
def login(form_data: Annotated[OAuth2PasswordRequestForm, Depends()]):
    ...
    expires = login_time + timedelta(seconds=2*3600)
